document.addEventListener('DOMContentLoaded', () => {
  ...
  spacing.textContent += '.user-chip{overflow:hidden!important}.user-chip [data-user-email]{white-space:nowrap!important;display:block!important}';
  spacing.textContent += '.user-role{margin-left:auto;color:#16d3ef;font-size:.62rem;white-space:nowrap}';
